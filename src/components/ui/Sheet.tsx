  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center md:items-center">
      ...
      <div
        ...
        aria-label={title}
        className={[
          'relative flex max-h-[92vh] w-full flex-col rounded-t-3xl bg-sand-50 shadow-sheet',
          'animate-sheet-up md:max-h-[86vh] md:max-w-lg md:animate-pop-in md:rounded-3xl',
        ].join(' ')}
      >
        <header className="flex shrink-0 items-center gap-2 border-b border-sand-200 px-4 py-3">
        ...
        {footer ? (
          <footer className="safe-bottom shrink-0 border-t border-sand-200 bg-sand-50 px-4 py-3">
            {footer}
          </footer>
        ) : (
